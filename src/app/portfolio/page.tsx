...
export default function Portfolio() {
  return (
    ...
    <div className="w-screen max-h-[150rem] sm:max-h-[175rem] xl:max-h-[225rem] overflow-hidden bg-white pt-24 grid grid-cols-2 px-6 md:px-0 md:grid-cols-3 gap-y-3.5 gap-x-4 md:gap-x-6 lg:gap-x-8 md:gap-y-8 lg:gap-[42px]">
      <InfiniteCarousel
        hoverBehavior="pause"
